...
// ============================================================
define('RECIPIENT_EMAIL',  'info@algheroemobility.com');    // Where to send emails
define('RECIPIENT_NAME',   'Alghero E-Mobility');            // Recipient display name
define('FROM_EMAIL',       'noreply@algheroemobility.com');  // Sender address (must exist on your server)
