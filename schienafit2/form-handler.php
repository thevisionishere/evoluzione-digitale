...
// ============================================================
define('RECIPIENT_EMAIL',  'schienafit@gmail.com');      // Where to send emails
define('RECIPIENT_NAME',   'SchienaFit');                 // Recipient display name
define('FROM_EMAIL',       'noreply@example.com');        // Sender address (must exist on your server)
